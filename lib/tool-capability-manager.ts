...
export const toolRegistry: ToolDefinition[] = [
  ...
  {
    toolKey: "adobe_express",
    name: "Adobe Express",
    purpose: "Prepare governed internal Adobe Express briefs and future Preview-only project metadata readiness.",
    category: "marketing",
    version: "1.0.0",
    authenticationMethod: "future_oauth_or_service_account",
    requiredPermissions: ["Adobe credential owner approval", "Least-privilege Express project metadata or brief-prep scopes"],
    healthStatus: "readiness_only",
    supportedActions: [
      {
    ...
    lastSuccessfulRunAt: null,
    lastFailureAt: null,
    retryPolicy: "Use internal creative brief fallback; never create, export, share, publish, or spend.",
    owner: "Creative Studio",
    auditHistory: ["adobe_express_governed_registry_ready"],
    approvalRequirements: ["Brand approval", "Content approval", "Security and scope review"],
    fallbackToolKeys: ["manual_design_brief"],
    providerCallsAllowed: false,
    safetyNotes: "Adobe Express is governed preparation only in v1. No Adobe API calls, design creation, export, publishing, sharing, or paid action.",
  },
  {
    toolKey: "adobe_firefly",
    name: "Adobe Firefly",
    purpose: "Prepare governed Firefly prompts and future Preview-only credential readiness without generating assets.",
    category: "marketing",
    version: "1.0.0",
    authenticationMethod: "future_oauth_or_service_account",
    requiredPermissions: ["Adobe credential owner approval", "Exact Firefly scopes", "Cost controls"],
    healthStatus: "readiness_only",
    supportedActions: [
      {
    ...
    owner: "Creative Studio",
    auditHistory: ["adobe_firefly_governed_registry_ready"],
    approvalRequirements: ["Brand approval", "Prompt review", "Cost approval", "Security and scope review"],
    fallbackToolKeys: ["manual_design_brief"],
    providerCallsAllowed: false,
    safetyNotes: "Firefly generation is blocked in v1. The system may prepare prompts and readiness reports only.",
  },
  {
    toolKey: "adobe_creative_cloud_assets",
    name: "Adobe Creative Cloud Assets",
    purpose: "Prepare future governed asset metadata reads and internal brand asset inventory reviews.",
    category: "marketing",
    version: "1.0.0",
    authenticationMethod: "future_oauth_or_service_account",
    requiredPermissions: ["Adobe admin approval", "Least-privilege asset metadata scopes"],
    healthStatus: "readiness_only",
    supportedActions: [
      {
    ...
    lastSuccessfulRunAt: null,
    lastFailureAt: null,
    retryPolicy: "Record a data gap and use approved manual asset inventory.",
    owner: "Creative Studio",
    auditHistory: ["adobe_assets_governed_registry_ready"],
    approvalRequirements: ["Security review", "Privacy review", "Least-privilege scope approval"],
    fallbackToolKeys: ["manual_design_brief"],
    providerCallsAllowed: false,
    safetyNotes: "Creative Cloud asset handling is metadata-readiness only in v1. No uploads, edits, deletes, exports, sharing, or files.",
  },
  {
    toolKey: "adobe_acrobat",
    name: "Adobe Acrobat / PDF Services",
    purpose: "Prepare governed PDF workflow plans without document creation, signing, export, or sharing.",
    category: "marketing",
    version: "1.0.0",
    authenticationMethod: "future_service_account",
    requiredPermissions: ["Document security review", "Template approval", "Adobe PDF Services credential approval"],
    healthStatus: "readiness_only",
    supportedActions: [
      {
    ...
    lastSuccessfulRunAt: null,
    lastFailureAt: null,
    retryPolicy: "Keep PDF work as internal workflow planning only.",
    owner: "Document Intelligence",
    auditHistory: ["adobe_acrobat_governed_registry_ready"],
    approvalRequirements: ["Security review", "Document approval", "Credential owner approval"],
    fallbackToolKeys: ["manual_design_brief"],
    providerCallsAllowed: false,
    safetyNotes: "PDF Services execution is blocked in v1. No PDF creation, signing, export, sharing, or provider spend.",
  },
  {
  ...
  {
    toolKey: "linkedin_company_page",
    name: "LinkedIn Company Page",
    purpose:
      "Store public LinkedIn Company Page metadata and prepare future approval-controlled company-page content planning.",
    category: "marketing",
    version: "1.0.0",
    authenticationMethod: "future_oauth_not_started",
    requiredPermissions: ["Planning only", "Future organization scope review", "Future company-page publish approval"],
    healthStatus: "readiness_only",
    supportedActions: [
      {
        actionKey: "prepare_linkedin_company_post",
        label: "Prepare LinkedIn company post",
        risk: "medium",
        approvalRequired: true,
        externalAction: false,
        liveExecutionAllowed: false,
      ...
      {
        actionKey: "prepare_linkedin_article",
        label: "Prepare LinkedIn article",
        risk: "medium",
        approvalRequired: true,
        externalAction: false,
        liveExecutionAllowed: false,
    ...
    lastSuccessfulRunAt: null,
    lastFailureAt: null,
    retryPolicy: "No live retries. Keep LinkedIn work as internal planning metadata until OAuth and approvals exist.",
    owner: "Marketing",
    auditHistory: ["linkedin_company_page_public_metadata_configured"],
    approvalRequirements: ["Human content approval", "Future OAuth approval", "Future company-page publishing policy"],
    fallbackToolKeys: ["manual_marketing_draft"],
    providerCallsAllowed: false,
    safetyNotes:
      "Public page only: https://www.linkedin.com/company/109661667/. No OAuth, API calls, publishing, scheduling, scraping, automation, or connector writes.",
  },
  {
