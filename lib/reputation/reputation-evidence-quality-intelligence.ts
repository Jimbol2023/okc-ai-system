...
const buildMissingEvidenceFindings = (input: ReputationEvidenceQualityInput): ReputationEvidenceQualityFinding[] => {
  ...
  return [
    createFinding({
      ...
      affectedGovernanceDomains: input.governanceResult?.affectedGovernanceDomains,
...
const buildConsistencyFindings = (input: ReputationEvidenceQualityInput): ReputationEvidenceQualityFinding[] => {
  ...
  return [
    createFinding({
      ...
      affectedBusinessUnits: input.remediationResult?.affectedBusinessUnits,
      affectedGovernanceDomains: input.remediationResult?.affectedGovernanceDomains,
