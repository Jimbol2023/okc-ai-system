...
export const defaultAutonomyPolicies: AutonomyPolicyDefinition[] = [
  {
    ...
    blockedActions: ["normalize_property_address", "scrape_google_maps", "infer_distress", "infer_owner_motivation", "create_lead", "create_property_opportunity", "send_sms", "send_email", "direct_mail", "provider_write"],
