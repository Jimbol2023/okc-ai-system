...
export const ueipProviderSurfaceInventory: ProviderSurfaceRecord[] = [
  ...
  { id: "ga4-certified-adapter", path: "lib/ueip-ga4-adapter.ts", provider: "Google Analytics 4", capability: "traffic, page performance, and key-event readiness reads", classification: "read_only", owner: "Integration Platform Engineering", authentication: "UEIP credential broker / OAuth refresh", tenantScope: "ConnectorInstallationState tenant", policyCoverage: "UEIP runtime gateway and GA4 feature flag", auditCoverage: "append-only gateway and health evidence", migrationStatus: "migrated", retirementDependency: "none" },
