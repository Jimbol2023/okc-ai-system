    ...
    >
      <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
        <div className="space-y-2">
          <p className="text-sm font-semibold uppercase tracking-[0.16em] text-muted">Lead quality intelligence</p>
          <h2 id="lead-quality-intelligence-heading" className="text-xl font-semibold text-primary">
            Read-only lead quality priority summary
          </h2>
          <p id="lead-quality-intelligence-summary" className="max-w-3xl text-sm leading-6 text-muted">
      ...
      <div className="mt-4 rounded-2xl border border-blue-100 bg-blue-50 p-4 text-sm leading-6 text-blue-950">
        <h3 className="font-semibold text-blue-950">Human-only lead quality guidance</h3>
        <p className="mt-1">
