    ...
    >
      <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
        <div className="space-y-2">
          ...
          <h2 id="buyer-ready-disposition-priority-heading" className="text-xl font-semibold text-primary">
            Read-only buyer-ready priority summary
          </h2>
          <p id="buyer-ready-disposition-priority-summary" className="max-w-3xl text-sm leading-6 text-muted">
      ...
      <div className="mt-4 grid gap-3 lg:grid-cols-7" aria-label="Missing buyer package data">
        {packageGaps.map((item) => (
          <article key={item.gap} className="rounded-2xl border border-border bg-white p-4">
            ...
            <p className="mt-1 text-sm leading-6 text-muted">Missing package data requires manual verification.</p>
          </article>
        ))}
      </div>

      <div className="mt-4 rounded-2xl border border-blue-100 bg-blue-50 p-4 text-sm leading-6 text-blue-950">
        <h3 className="font-semibold text-blue-950">Operator package-prep guidance</h3>
        <p className="mt-1">
