    ...
    >
      <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
        <div className="space-y-2">
          ...
          <h2 id="operator-work-queue-intelligence-heading" className="text-xl font-semibold text-primary">
            Read-only workload priority summary
          </h2>
          <p id="operator-work-queue-intelligence-summary" className="max-w-3xl text-sm leading-6 text-muted">
      ...
      <div className="mt-4 rounded-2xl border border-blue-100 bg-blue-50 p-4 text-sm leading-6 text-blue-950">
        <h3 className="font-semibold text-blue-950">Manual-review guidance</h3>
        <p className="mt-1">
