    ...
    >
      <div className="flex min-w-0 flex-col gap-3 md:flex-row md:items-start md:justify-between">
        <div className="min-w-0 space-y-2">
          ...
          <h2 id="stuck-deal-recovery-summary-heading" className="break-words text-xl font-semibold text-primary">
      ...
      <div className="mt-4 grid gap-3 md:grid-cols-2 xl:grid-cols-3" aria-label="Revenue leakage indicators">
