    ...
    >
      <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
        <div className="space-y-2">
          ...
          <h2 id="near-close-revenue-recovery-heading" className="text-xl font-semibold text-primary">
      ...
      <div className="mt-4 grid gap-3 lg:grid-cols-3" aria-label="Pre-closing revenue leakage indicators">
