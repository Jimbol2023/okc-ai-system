...
import { runSearchConsolePreviewPilot } from "@/lib/ueip-preview-pilot";
...
export async function POST(request: Request) {
  ...
  return NextResponse.json(await runSearchConsolePreviewPilot({ actor: { tenantId: auth.tenantId, actorId: auth.actorId }, confirmation: body.confirmation ?? "", operation: body.operation, nonce: body.nonce }));
}
